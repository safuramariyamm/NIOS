...
const heroImage = "https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?auto=format&fit=crop&w=1800&q=85";
...
/*  Background and foreground both use the same programs photo.        */
/* ------------------------------------------------------------------ */
      ...
      <div className="mx-auto grid w-full max-w-7xl items-center gap-10 pb-12 lg:grid-cols-[1.02fr_0.98fr] lg:gap-14 lg:pb-10">
        ...
        >
          ...
          <h1 className="mt-6 text-5xl font-bold leading-[0.98] text-[#1E293B] sm:text-6xl lg:text-7xl xl:text-[5rem]">
            Full-circle care for every child&apos;s{" "}
          ...
          <div className="mt-7 flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm font-semibold text-[#334155]">5,000+ children reached.</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            ...
            {/* <div className="relative aspect-[1/1.05] w-full [mask-image:radial-gradient(ellipse_58%_58%_at_50%_42%,#000_60%,rgba(0,0,0,0.55)_78%,transparent_100%)]">
              <Image
                src={heroImage}
                alt="Children learning together at a BrightPath program"
                fill
                priority
            ...
            >
              ...
              {/* <div>
                ...
                <p className="mt-1 text-xs text-[#64748B]">reached across programs</p>
              </div> */}
            </motion.div>
            ...
            >
              <p className="flex items-center gap-1 text-sm font-bold text-[#9A3412]">
                <Sparkles className="h-4 w-4 text-[#F97316]" /> 120+ schools connected
              </p>
            </motion.div> */}
          </motion.div>
        </motion.div>
