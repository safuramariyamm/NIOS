...
export function ImpactSection() {
  return (
    <section className="px-4 py-20 sm:px-6 lg:px-8">
      <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.4 }} className="relative mx-auto overflow-hidden rounded-[40px] bg-gradient-to-r from-[#F97316] via-[#EC4899] to-[#2563EB] p-8 shadow-[0_30px_90px_rgba(37,99,235,0.2)] sm:p-10 lg:p-14">
